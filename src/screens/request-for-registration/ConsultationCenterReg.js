...
const ConsultationCenterReg = (props) => {
    ...
    const initialInformation = {
        retail_type: 'Consultation Center',
        center_name: '',
        center_address: '',
        shop_longitude: '',
        shop_latitude: '',
    ...
    const { validateConsultationCenterInfo } = useValidation();
    ...
    const handleDataChange = (e) => {
        ...
        timerRef.current = setTimeout(() => {
            if (clickOnSubmit) {
                ...
                validateConsultationCenterInfo(information, setErrors);
            }
        }, 500);
    };
    ...
    const getConnectionStatus = () => {
        ...
        const isInputValid = validateConsultationCenterInfo(information, setErrors);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f1f5f7', alignItems: 'center', width: screenWidth }}>
            ...
            {information?.district_info === '' && information?.shop_latitude === '' && information?.shop_longitude === '' ?
                ...
                :
                <>
                    <HeaderCommon title={`Add Consultation Center`} toggleDrawer={props.navigation} />
                    <ScrollView>
                            ...
                            <View style={styles.body}>
                                ...
                                <View style={{ marginHorizontal: 8 }}>
                                    <Text style={styles.level}>
                                        <Text style={styles.level}>Consultation Center Name</Text>
                                    </Text>
                                    <TextInput placeholder='' keyboardType='default' secureTextEntry={false} multiline={true}
                                        ...
                                        value={information.center_name}
                                        style={styles.textBox} />
                                    {clickOnSubmit && errors?.center_name && (<Text style={styles.alert}>{errors?.center_name}</Text>)}
                                    ...
                                    <TextInput placeholder='' keyboardType='default' secureTextEntry={false} multiline={true}
                                        ...
                                        value={information.center_address}
                                        style={styles.address} />
                                    {clickOnSubmit && errors?.center_address && (<Text style={styles.alert}>{errors?.center_address}</Text>)}
...
export default ConsultationCenterReg;