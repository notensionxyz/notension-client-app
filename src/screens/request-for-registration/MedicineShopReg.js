...
const MedicineShopReg = (props) => {
    ...
    const { validateRetailInformation } = useValidation();
    ...
    const handleDataChange = (e) => {
        ...
        timerRef.current = setTimeout(() => {
            if (clickOnSubmit) {
                ...
                validateRetailInformation(information, setErrors);
            }
        }, 500);
    };
    ...
    const getConnectionStatus = () => {
        ...
        const isInputValid = validateRetailInformation(information, setErrors);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f1f5f7', alignItems: 'center', width: screenWidth }}>
            ...
            {information?.district_info === '' && information?.shop_latitude === '' && information?.shop_longitude === '' ?
                ...
                :
                <>
                    <HeaderCommon title={`Req. to add medicine shop`} toggleDrawer={props.navigation} />
                    <ScrollView>
                            ...
                            <View style={styles.body}>
                                ...
                                <View style={{ marginHorizontal: 8 }}>
                                    <Text style={styles.level}>
                                        <Text style={styles.level}>দোকানের নাম</Text>
                                    </Text>
                                    ...
                                    {clickOnSubmit && errors?.shop_name && (<Text style={styles.alert}>{errors?.shop_name}</Text>)}
                                    ...
                                    {clickOnSubmit && errors?.shop_address && (<Text style={styles.alert}>{errors?.shop_address}</Text>)}
                                    ...
                                    <Text style={styles.level}>মোবাইল নম্বর</Text>
...
export default MedicineShopReg;