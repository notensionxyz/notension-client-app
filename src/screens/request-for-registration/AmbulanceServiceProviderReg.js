...
const AmbulanceServiceProviderReg = (props) => {
    ...
    const initialInformation = {
        retail_type: 'Ambulance Service Provider',
        provider_name: '',
        provider_address: '',
        shop_longitude: '',
        shop_latitude: '',
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f1f5f7', alignItems: 'center', width: screenWidth }}>
            ...
            {information?.district_info === '' && information?.shop_latitude === '' && information?.shop_longitude === '' ?
                ...
                :
                <>
                    <HeaderCommon title={`Ambulance Service Provider`} toggleDrawer={props.navigation} />
                    <ScrollView>
...
export default AmbulanceServiceProviderReg;